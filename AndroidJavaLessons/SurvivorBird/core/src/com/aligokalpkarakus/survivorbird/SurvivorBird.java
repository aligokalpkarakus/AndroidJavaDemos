package com.aligokalpkarakus.survivorbird;
...
public class SurvivorBird extends ApplicationAdapter {
	...
	@Override //oyun açıldığında olacaklar
	public void create () {
	...
	@Override	//oyun devam ederken olan şeyler buraya sürekli olan
	public void render () {
		...
		if(gameState == 1){
			...
			font2.draw(batch,"Game Over! Tap To Play Again!", Gdx.graphics.getWidth() / (float) 4.5, Gdx.graphics.getHeight() / (float) 1.5);
